...
const translations = {
  en: {
    ...
    'desktop.text': 'The browser app stores data in this browser. The Electron desktop version is available from GitHub Releases when an installer has been published.',
    ...
    'desktop.text': 'Selainversio tallentaa tiedot tähän selaimeen. Electron-työpöytäversio on saatavilla GitHub Releases -julkaisuista, kun asennusohjelma on julkaistu.',
  ...
  it: {
    ...
    'desktop.text': 'La versione browser salva i dati in questo browser. La versione desktop Electron e disponibile da GitHub Releases quando viene pubblicato un installer.',
